    ...
    <div class='navSwiper'>
        <div class='content'>
            <div class='navigation'>
                <ul>
                    <li v-for='item in firstCategorys' :key='item.id' @mouseenter="mourseHover(item.id)"
                        ...
                        <div class='category-detail' v-if='isFirst'>
                            <div class='detail-main'>
                                ...
                                <div class='detail-list'>
                                    ...
                                    <div class='list-ul'>
                                        <router-link v-for='item in tagsList' :key='item.id' to='/' class='list-item'>{{
...
<!-- 
                                                    ...
                                                    <div class="coursePrice" v-else-if="item.isMember == 1">
                                                        <div class="courseMemberbg"><span class="courseMember">会员免费</span>
                                                        </div>
                                                        <div class="price">¥ {{ item.discountPrice }}</div>
                                                    </div>
                                                    ...
                                                    <!-- <div class='cart'>
                                                        <div class='cart-image'>
                                                            <el-icon color='red' :size='24'><shopping-cart
                                                                    style="width: 24px; height:24px;" /></el-icon>
                                                        </div>
            ...
            <div class='sliders'>
                <el-carousel :interval="5000" arrow="always" height="460px" v-if="slidersList.length > 0">
