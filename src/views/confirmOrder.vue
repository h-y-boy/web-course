        ...
        <div class="main">
            <div class="info">
                ...
                <div class="choose">
                    ...
                    <div class="choosebg">
                        <span v-for='item in payModes' :key='item.wxpayment' @click='tabPayment(item)'>{{ item.description
                        }}</span>
                    </div>
                </div>
                <ul class="foot">
...
//api
import { settlement, alipayOrder, wxpayOrder, deleteShopCars } from '@/utils/api/cart'
import { createToken } from '../utils/api/login';
//pinia
