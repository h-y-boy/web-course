                ...
                <div class="search-item" style="top: 90px;">
                    ...
                    <div class="all-items">
                        ...
                        <el-tag v-for='item in courseLevel' :key='item.id'
                            ...
                            effect="plain" type="info" @click='buildingCondition("clevel", item.code)'> {{ item.text }}
                        </el-tag>
                    </div>
                </div>
            </section>
        ...
        <div class='main-container'>
            <div class="container-top">
                <ul class="all">
                    ...
                    <li class="item" @click="handleNewCourse" :style='priceSortBy == "2" ? "color:#2C80FF" : ""'>最新课程</li>
                    <li class="item split">|</li>
                        ...
                        <li class='courseItem' v-for='item in courseList' :key='item.id'>
                            <router-link :to="{ path: '/course-info/' + item.id }">
                                <div class='courseInfo'>
                                    ...
                                    <div class="courseDegree">{{ courseTypeFn(item.courseLevel) }} · {{ item.purchaseCounter
                                        +
                                        item.purchaseCnt }}人报名</div>
